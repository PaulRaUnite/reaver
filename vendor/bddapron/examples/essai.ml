...
let va = Apron.Var.of_string "a";;
let vb = Apron.Var.of_string "b";;
let vc = Apron.Var.of_string "c";;
let env = Apron.Environment.make [||] [|va;vb;vc|];;
let linexpr = Apron.Parser.linexpr_of_string env "a+3b-4";;
let man = Polka.manager_alloc_loose ();;
let abs = Apron.Abstract1.top man env;;
let abs2 = Apron.Abstract1.assign_linexpr man abs "c" linexpr None;;
